...
void gh_enter(int argc, char *argv[],
...
SCM gh_ulong2scm(uint64_t x);
SCM gh_long2scm(int64_t x);
SCM gh_double2scm(double x);
SCM gh_char2scm(char c);
SCM gh_str2scm(const char *s, size_t len);
SCM gh_str02scm(const char *s);
void gh_set_substr(const char *src, SCM dst, int64_t start, size_t len);
SCM gh_symbol2scm(const char *symbol_str);
SCM gh_ints2scm(const int *d, int64_t n);

SCM gh_chars2byvect(const char *d, int64_t n);
SCM gh_shorts2svect(const short *d, int64_t n);
SCM gh_longs2ivect(const int64_t *d, int64_t n);
SCM gh_ulongs2uvect(const uint64_t *d, int64_t n);
SCM gh_floats2fvect(const float *d, int64_t n);
SCM gh_doubles2dvect(const double *d, int64_t n);

SCM gh_doubles2scm(const double *d, int64_t n);

/* Scheme to C conversion */
int gh_scm2bool(SCM obj);
int gh_scm2int(SCM obj);
uint64_t gh_scm2ulong(SCM obj);
int64_t gh_scm2long(SCM obj);
char gh_scm2char(SCM obj);
double gh_scm2double(SCM obj);
char *gh_scm2newstr(SCM str, size_t *lenp);
void gh_get_substr(SCM src, char *dst, int64_t start, size_t len);
...
int64_t *gh_scm2longs(SCM vector, int64_t *result);
...
uint64_t gh_vector_length (SCM v);
uint64_t gh_uniform_vector_length (SCM v);
