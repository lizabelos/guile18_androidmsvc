...
#define SCM_I_ULLONG_MAX  SCM_I_UTYPE_MAX(uint64_t)
#define SCM_I_LLONG_MIN   SCM_I_TYPE_MIN(int64_t,SCM_I_ULLONG_MAX)
#define SCM_I_LLONG_MAX   SCM_I_TYPE_MAX(int64_t,SCM_I_ULLONG_MAX)
