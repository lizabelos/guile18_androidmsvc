...
SCM scm_typed_array_p (SCM v, SCM type);
SCM scm_make_array (SCM fill, SCM bounds);
SCM scm_make_typed_array (SCM type, SCM fill, SCM bounds);
SCM scm_array_rank (SCM ra);
size_t scm_c_array_rank (SCM ra);
SCM scm_array_dimensions (SCM ra);
SCM scm_shared_array_root (SCM ra);
SCM scm_shared_array_offset (SCM ra);
SCM scm_shared_array_increments (SCM ra);
SCM scm_make_shared_array (SCM oldra, SCM mapfunc, SCM dims);
SCM scm_transpose_array (SCM ra, SCM args);
SCM scm_enclose_array (SCM ra, SCM axes);
SCM scm_array_in_bounds_p (SCM v, SCM args);
SCM scm_array_ref (SCM v, SCM args);
SCM scm_array_set_x (SCM v, SCM obj, SCM args);
SCM scm_array_contents (SCM ra, SCM strict);
SCM scm_uniform_array_read_x (SCM ra, SCM port_or_fd,
				      SCM start, SCM end);
SCM scm_uniform_array_write (SCM v, SCM port_or_fd,
				     SCM start, SCM end);
SCM scm_array_to_list (SCM v);
SCM scm_list_to_array (SCM ndim, SCM lst);
SCM scm_list_to_typed_array (SCM type, SCM ndim, SCM lst);
SCM scm_array_type (SCM ra);
...
size_t scm_array_handle_rank (scm_t_array_handle *h);
scm_t_array_dim *scm_array_handle_dims (scm_t_array_handle *h);
ssize_t scm_array_handle_pos (scm_t_array_handle *h, SCM indices);
const SCM *scm_array_handle_elements (scm_t_array_handle *h);
SCM *scm_array_handle_writable_elements (scm_t_array_handle *h);
...
SCM scm_bitvector_p (SCM vec);
SCM scm_bitvector (SCM bits);
SCM scm_make_bitvector (SCM len, SCM fill);
SCM scm_bitvector_length (SCM vec);
SCM scm_bitvector_ref (SCM vec, SCM idx);
SCM scm_bitvector_set_x (SCM vec, SCM idx, SCM val);
SCM scm_list_to_bitvector (SCM list);
SCM scm_bitvector_to_list (SCM vec);
SCM scm_bitvector_fill_x (SCM vec, SCM val);
...
SCM scm_istr2bve (SCM str);

int scm_is_bitvector (SCM obj);
SCM scm_c_make_bitvector (size_t len, SCM fill);
size_t scm_c_bitvector_length (SCM vec);
SCM scm_c_bitvector_ref (SCM vec, size_t idx);
void scm_c_bitvector_set_x (SCM vec, size_t idx, SCM val);
...
size_t scm_array_handle_bit_elements_offset (scm_t_array_handle *h);
...
SCM scm_i_make_ra (int ndim, int enclosed);
SCM scm_i_cvref (SCM v, size_t p, int enclosed);
SCM scm_i_read_array (SCM port, int c);

/* deprecated. */

#if SCM_ENABLE_DEPRECATED

SCM scm_make_uve (int64_t k, SCM prot);
...
SCM scm_shap2ra (SCM args, const char *what);
SCM scm_cvref (SCM v, uint64_t pos, SCM last);
void scm_ra_set_contp (SCM ra);
SCM_API int64_t scm_aind (SCM ra, SCM args, const char *what);
int scm_raprin1 (SCM exp, SCM port, scm_print_state *pstate);
