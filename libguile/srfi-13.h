...
SCM scm_substring_to_list (SCM str, SCM start, SCM end);
...
SCM scm_substring_move_x (SCM str1, SCM start1, SCM end1,
				  SCM str2, SCM start2);
...
SCM scm_substring_fill_x (SCM str, SCM chr, SCM start, SCM end);
...
SCM scm_substring_hash (SCM s, SCM bound, SCM start, SCM end);
SCM scm_substring_hash_ci (SCM s, SCM bound, SCM start, SCM end);
...
SCM scm_string_index (SCM s, SCM char_pred, SCM start, SCM end);
SCM scm_string_index_right (SCM s, SCM char_pred, SCM start, SCM end);
SCM scm_string_rindex (SCM s, SCM char_pred, SCM start, SCM end);
...
SCM scm_substring_upcase_x (SCM str, SCM start, SCM end);
SCM scm_substring_upcase (SCM str, SCM start, SCM end);
SCM scm_string_upcase_x (SCM str);
SCM scm_string_upcase (SCM str);
SCM scm_substring_downcase_x (SCM str, SCM start, SCM end);
SCM scm_substring_downcase (SCM str, SCM start, SCM end);
SCM scm_string_downcase_x (SCM str);
SCM scm_string_downcase (SCM str);
SCM scm_string_titlecase_x (SCM str, SCM start, SCM end);
SCM scm_string_titlecase (SCM str, SCM start, SCM end);
SCM scm_string_capitalize_x (SCM str);
SCM scm_string_capitalize (SCM str);
...
SCM scm_string_split (SCM s, SCM chr);
